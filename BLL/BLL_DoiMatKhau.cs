...
namespace BLL
{
    ...
    public class BLL_DoiMatKhau
    {
        ...
        //    return _DoiMatKhauDAL.KiemTraMatKhauMacDinh(soDienThoai, loaiTaiKhoan);
        //}
        public bool LaLanDauDangNhapp(string soDienThoai)
        {
            return _DoiMatKhauDAL.KiemTraMatKhauMacDinhh(soDienThoai);
        }

        public bool DoiMatKhau(string soDienThoai, string matKhauMoi)
        {
            return _DoiMatKhauDAL.DoiMatKhau(soDienThoai, matKhauMoi);
        }
    }
}
